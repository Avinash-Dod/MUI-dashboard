        ...
        <Box >
            ...
            <Stack direction="row" spacing={1} justifyContent="start" flexDirection="row" height='100%' >
                ...
                {/* <List >
                                {location.map(branch => (
                                    <>
                                        <CouponList color="#666" key={Object.keys(branch.address)} >
                                            <ListItem sx={{ width: "100%" }}   >

                                                <ListItemAvatar sx={{ float: "left" }}>
                                                    <img src={branch.src} alt={branch.CouponName} />
                                                </ListItemAvatar>
                                                <ListItemText sx={{ width: "100%",marginRight:"15%" }} >
                                                    <Text name={branch.CouponName} variant="p"
                    ...
                    <VPageContainer >
                        ...
                        <PageText variant="h4" component="div" name="Coupon Management" width="100%" color="#30AADD" mb="6%" mt="4%" />
