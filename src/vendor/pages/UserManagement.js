...
import DeleteUser from "../components/modals/action modals/DeleteUser"
import DeactivateUser from "../components/modals/action modals/DeactivateUser"
        ...
        <Box >
            ...
            <Stack direction="row" spacing={1} justifyContent="start" flexDirection="row" height='100%' >
                ...
                <PageContainer maxWidth='100%'  >
                    <PageText variant="h4" component="div" name="User Management" width="100%" color="#30AADD" mt="4%" />
...
<tr><td colSpan={4}><h3> <i class="fa fa-times-circle"></i> Nothing in Cart</h3></td></tr>
                ...
                <EditUser open={edit} close={setEdit} />
                <DeleteUser open={Delete} close={setDelete} />
                <DeactivateUser open={Deactivate} close={setDeactivate} />
