...
import AddPrepaidUser from "../components/modals/AddPrepaidUser"
    ...
    return (
        <Box >
            ...
            <Stack direction="row" spacing={1} justifyContent="start" flexDirection="row" height='100%' >
                ...
                <PageContainer maxWidth='100%'  >
                    ...
                    <VPageContainer >
                        <Box alignContent="center" sx={{ width: { xs: "100%" } }} >
                            ...
                            <PageText variant="h4" component="div" name="My Prepaid Card" width="55%" color="#30AADD" mb="5%" mt="4%" textAlign="right" />
                ...
                <AddPrepaidUser open={open} close={setOpen} />
