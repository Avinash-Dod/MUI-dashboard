        ...
        <Dialog
            ...
            <DialogContent>
                <Box sx={{ textAlign: "center", padding: 5 }}>
                    ...
                    <Text name="Delete User" variant="h5" component="div" fontWeight="bold" color="#30AADD" mb="2%" />
                    <Text name="Are you sure want to Delete User? " variant="h6" component="div" mb="4%" />
