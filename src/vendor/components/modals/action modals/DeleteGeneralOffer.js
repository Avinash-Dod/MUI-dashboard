...
const DeleteGeneralOffer = (props) => {
    const handleClose = () => {
        props.close(false)
    };
        ...
        <Dialog
            ...
            <DialogContent>
                <Box sx={{ textAlign: "center", padding: 5 }}>
                    ...
                    <Text name="Delete General Offer" variant="h5" component="div" fontWeight="bold" color="#30AADD" mb="2%" />
...
export default DeleteGeneralOffer
